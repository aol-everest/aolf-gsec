...
export const CalendarMenuIconV2: React.FC<IconProps> = React.memo(({ width = "24", height = "24", ...props }) => (
    <SvgIcon viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path fill="none" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M3.5 9.09009H20.5"/>
        <path fill="none" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z"/>
        <path fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M15.6947 13.7H15.7037" />
        <path fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M15.6947 16.7H15.7037" />
        <path fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M11.9955 13.7H12.0045" />
        <path fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M11.9955 16.7H12.0045" />
        <path fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M8.29431 13.7H8.30329" />
        <path fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M8.29431 16.7H8.30329" />
    </SvgIcon>
));

export const CalendarDayFilledIconV2: React.FC<IconProps> = React.memo(({ width = "24", height = "24", ...props }) => (
...
export const CalendarFilledIconV2: React.FC<IconProps> = React.memo(({ width = "24", height = "24", ...props }) => (
    <SvgIcon viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path fill="currentColor" d="M18.5,2H18V1.5A1.5,1.5,0,0,0,16.5,0h0A1.5,1.5,0,0,0,15,1.5V2H9V1.5A1.5,1.5,0,0,0,7.5,0h0A1.5,1.5,0,0,0,6,1.5V2H5.5A5.5,5.5,0,0,0,0,7.5v11A5.5,5.5,0,0,0,5.5,24h13A5.5,5.5,0,0,0,24,18.5V7.5A5.5,5.5,0,0,0,18.5,2Zm0,19H5.5A2.5,2.5,0,0,1,3,18.5V10H21v8.5A2.5,2.5,0,0,1,18.5,21Z"/>
    </SvgIcon>
));
...
export const RefreshIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M3.09 9.27C3.82 5.77 7.07 3.37 10.62 3.37c1.68 0 3.26 0.97 4.55 2.07l-1.16 1.16c-0.39 0.39 -0.39 1.02 0 1.41c0.19 0.19 0.44 0.29 0.7 0.29H19c0.55 0 1 -0.45 1 -1V2.97c0 -0.55 -0.45 -1 -1 -1c-0.26 0 -0.52 0.1 -0.7 0.29l-1.3 1.3C15.08 1.38 12.94 0.98 10.62 0.98c-5.12 0 -9.37 3.93 -9.82 9.02c-0.13 0.82 0.42 1.6 1.24 1.73c0.07 0.01 0.15 0.02 0.22 0.02C2.67 11.75 2.99 10.67 3.09 9.27z"/>
        <path fill="currentColor" d="M22.78 11.98c-0.75 0.01 -1.39 0.57 -1.48 1.32c-0.73 5.5 -4.98 7.87 -8.68 7.87c-1.68 0 -3.26 -0.97 -4.55 -2.07l1.16 -1.16c0.39 -0.39 0.39 -1.02 0 -1.41c-0.19 -0.19 -0.44 -0.29 -0.7 -0.29H5c-0.55 0 -1 0.45 -1 1v4.29c0 0.55 0.45 1 1 1c0.26 0 0.52 -0.1 0.7 -0.29l1.3 -1.3c1.92 2.18 4.06 2.58 6.38 2.58c5.12 0 9.37 -3.93 9.82 -9.02c0.13 -0.82 -0.42 -1.6 -1.24 -1.73C22.89 11.98 22.83 11.98 22.78 11.98z"/>
    </SvgIcon>
));
...
export const DownloadFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const InfoCommentFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M12.836,.028C9.361-.202,5.961,1.066,3.509,3.521,1.057,5.977-.211,9.378,.03,12.854c.44,6.354,6.052,11.146,13.054,11.146h5.917c2.757,0,5-2.243,5-5v-6.66C24,5.861,19.096,.454,12.836,.028Zm-.933,18.972c-.828,0-1.5-.672-1.5-1.5s.672-1.5,1.5-1.5,1.5,.672,1.5,1.5-.672,1.5-1.5,1.5Zm1.928-6.512c-.521,.287-.928,.952-.928,1.512,0,.553-.448,1-1,1s-1-.447-1-1c0-1.284,.807-2.626,1.963-3.264,.763-.42,1.157-1.254,1.004-2.125-.138-.787-.81-1.458-1.596-1.596-.606-.107-1.195,.047-1.656,.435-.455,.381-.715,.94-.715,1.533,0,.552-.448,1-1,1s-1-.447-1-1c0-1.185,.521-2.302,1.429-3.064,.908-.762,2.109-1.077,3.287-.873,1.613,.283,2.938,1.606,3.221,3.22,.298,1.699-.509,3.395-2.009,4.222Z"/>
    </SvgIcon>
));
...
export const EyeIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M23.271,9.419C21.72,6.893,18.192,2.655,12,2.655S2.28,6.893.729,9.419a4.908,4.908,0,0,0,0,5.162C2.28,17.107,5.808,21.345,12,21.345s9.72-4.238,11.271-6.764A4.908,4.908,0,0,0,23.271,9.419Zm-1.705,4.115C20.234,15.7,17.219,19.345,12,19.345S3.766,15.7,2.434,13.534a2.918,2.918,0,0,1,0-3.068C3.766,8.3,6.781,4.655,12,4.655s8.234,3.641,9.566,5.811A2.918,2.918,0,0,1,21.566,13.534Z"/>
        <path fill="currentColor" d="M12,7a5,5,0,1,0,5,5A5.006,5.006,0,0,0,12,7Zm0,8a3,3,0,1,1,3-3A3,3,0,0,1,12,15Z"/>
    </SvgIcon>
));

export const EyeFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.19 512.19" {...props}>
        <circle fill="currentColor" cx="256.095" cy="256.095" r="85.333"/>
        <path fill="currentColor" d="M496.543,201.034C463.455,147.146,388.191,56.735,256.095,56.735S48.735,147.146,15.647,201.034   c-20.862,33.743-20.862,76.379,0,110.123c33.088,53.888,108.352,144.299,240.448,144.299s207.36-90.411,240.448-144.299   C517.405,277.413,517.405,234.777,496.543,201.034z M256.095,384.095c-70.692,0-128-57.308-128-128s57.308-128,128-128   s128,57.308,128,128C384.024,326.758,326.758,384.024,256.095,384.095z"/>
    </SvgIcon>
));

export const QuestionCircleIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,22A10,10,0,1,1,22,12,10.011,10.011,0,0,1,12,22Z"/>
        <path fill="currentColor" d="M12.717,5.063A4,4,0,0,0,8,9a1,1,0,0,0,2,0,2,2,0,0,1,2.371-1.967,2.024,2.024,0,0,1,1.6,1.595,2,2,0,0,1-1,2.125A3.954,3.954,0,0,0,11,14.257V15a1,1,0,0,0,2,0v-.743a1.982,1.982,0,0,1,.93-1.752,4,4,0,0,0-1.213-7.442Z"/>
        <rect fill="currentColor" x="11" y="17" width="2" height="2" rx="1"/>
    </SvgIcon>
));

export const QuestionCircleFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,20a1,1,0,1,1,1-1A1,1,0,0,1,12,20Zm1.93-7.494A1.982,1.982,0,0,0,13,14.257V15a1,1,0,0,1-2,0v-.743a3.954,3.954,0,0,1,1.964-3.5,2,2,0,0,0,1-2.125,2.024,2.024,0,0,0-1.6-1.595A2,2,0,0,0,10,9,1,1,0,0,1,8,9a4,4,0,1,1,5.93,3.505Z"/>
    </SvgIcon>
));

export const QuestionSquareIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M12,16c.828,0,1.5,.672,1.5,1.5s-.672,1.5-1.5,1.5-1.5-.672-1.5-1.5,.672-1.5,1.5-1.5Zm1-2c0-.561,.408-1.225,.928-1.512,1.5-.827,2.307-2.523,2.009-4.222-.283-1.614-1.608-2.938-3.221-3.22-1.178-.205-2.379,.11-3.287,.873-.908,.763-1.429,1.879-1.429,3.064,0,.552,.448,1,1,1s1-.448,1-1c0-.592,.261-1.151,.715-1.533,.461-.388,1.049-.542,1.656-.435,.787,.138,1.458,.809,1.596,1.596,.153,.87-.241,1.704-1.004,2.125-1.156,.637-1.963,1.979-1.963,3.264,0,.553,.448,1,1,1s1-.447,1-1Zm11,5V5c0-2.757-2.243-5-5-5H5C2.243,0,0,2.243,0,5v14c0,2.757,2.243,5,5,5h14c2.757,0,5-2.243,5-5ZM19,2c1.654,0,3,1.346,3,3v14c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V5c0-1.654,1.346-3,3-3h14Z"/>
    </SvgIcon>
));

export const QuestionSquareFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M19,0H5C2.243,0,0,2.243,0,5v14c0,2.757,2.243,5,5,5h14c2.757,0,5-2.243,5-5V5c0-2.757-2.243-5-5-5Zm-7,19c-.828,0-1.5-.672-1.5-1.5s.672-1.5,1.5-1.5,1.5,.672,1.5,1.5-.672,1.5-1.5,1.5Zm1.928-6.512c-.521,.287-.928,.952-.928,1.512,0,.553-.448,1-1,1s-1-.447-1-1c0-1.284,.807-2.626,1.963-3.264,.763-.42,1.157-1.254,1.004-2.125-.138-.787-.81-1.458-1.596-1.596-.606-.107-1.195,.047-1.656,.435-.455,.381-.715,.94-.715,1.533,0,.552-.448,1-1,1s-1-.447-1-1c0-1.185,.521-2.302,1.429-3.064,.908-.762,2.109-1.077,3.287-.873,1.613,.283,2.938,1.606,3.221,3.22,.298,1.699-.509,3.395-2.009,4.222Z"/>
    </SvgIcon>
));

export const QuestionCommentIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M11.904,16c.828,0,1.5,.672,1.5,1.5s-.672,1.5-1.5,1.5-1.5-.672-1.5-1.5,.672-1.5,1.5-1.5Zm1-2c0-.561,.408-1.225,.928-1.512,1.5-.826,2.307-2.523,2.009-4.223-.283-1.613-1.607-2.938-3.221-3.221-1.182-.204-2.38,.112-3.289,.874-.907,.763-1.428,1.879-1.428,3.063,0,.553,.448,1,1,1s1-.447,1-1c0-.592,.26-1.15,.714-1.532,.461-.386,1.052-.542,1.657-.435,.787,.138,1.458,.81,1.596,1.596,.153,.871-.241,1.705-1.004,2.125-1.156,.637-1.963,1.979-1.963,3.264,0,.553,.448,1,1,1s1-.447,1-1Zm11.096,5v-6.66C24,5.861,19.096,.454,12.836,.028,9.361-.202,5.961,1.066,3.509,3.521,1.057,5.977-.211,9.378,.03,12.854c.44,6.354,6.052,11.146,13.054,11.146h5.917c2.757,0,5-2.243,5-5ZM12.701,2.024c5.215,.354,9.299,4.885,9.299,10.315v6.66c0,1.654-1.346,3-3,3h-5.917c-6.035,0-10.686-3.904-11.059-9.284-.201-2.899,.855-5.735,2.899-7.781,1.882-1.885,4.435-2.934,7.092-2.934,.228,0,.457,.008,.685,.023Z"/>
    </SvgIcon>
));

export const QuestionCommentFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const QuestionSquareCircleIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m12.006,23c-7.245,0-11.006-4.186-11.006-11.018C1,4.841,4.929,1.044,11.994,1c6.98.045,10.884,3.946,11.006,10.983-.133,7.28-3.832,10.975-10.994,11.017ZM3,12c.118,6.105,2.979,8.965,9.006,9,6.021-.036,8.882-2.901,8.994-9.019-.103-5.909-3.133-8.943-9.006-8.981-5.935.037-8.88,2.981-8.994,9Z"/>
        <path fill="currentColor" d="M12,15c-.552,0-1-.448-1-1v-1.411c0-.55.444-.997.994-1,1.489-.009,2.08-.603,2.107-2.12-.025-1.439-.656-2.073-2.108-2.083-1.458.009-2.068.624-2.095,2.119-.01.553-.504.977-1.018.982-.552-.01-.992-.466-.982-1.018.046-2.579,1.539-4.067,4.095-4.084,2.533.017,4.064,1.544,4.108,4.084-.042,2.292-1.133,3.687-3.102,4.033v.496c0,.552-.448,1-1,1Z"/>
        <circle fill="currentColor" cx="12" cy="18" r="1"/>
    </SvgIcon>
));

export const QuestionSquareCircleFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m11.994,1C4.929,1.044,1,5.018,1,12.019c0,6.843,3.933,10.94,11.006,10.981,7.162-.042,10.861-3.737,10.994-11.017-.122-7.037-4.026-10.938-11.006-10.983Zm.006,18c-.827,0-1.497-.67-1.497-1.497s.67-1.497,1.497-1.497,1.497.67,1.497,1.497-.67,1.497-1.497,1.497Zm1-6.12v.652c0,.552-.448,1-1,1s-1-.448-1-1v-1.567c0-.55.444-.997.994-1,1.489-.009,2.08-.603,2.107-2.12-.025-1.439-.656-2.073-2.108-2.083-1.458.009-2.068.624-2.095,2.119-.01.553-.504.977-1.018.982-.552-.01-.992-.466-.982-1.018.046-2.579,1.539-4.067,4.095-4.084,2.533.017,4.064,1.544,4.108,4.084-.042,2.292-1.133,3.687-3.102,4.033Z"/>
    </SvgIcon>
));

export const FileIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M19.949,5.536,16.465,2.05A6.958,6.958,0,0,0,11.515,0H7A5.006,5.006,0,0,0,2,5V19a5.006,5.006,0,0,0,5,5H17a5.006,5.006,0,0,0,5-5V10.485A6.951,6.951,0,0,0,19.949,5.536ZM18.535,6.95A4.983,4.983,0,0,1,19.316,8H15a1,1,0,0,1-1-1V2.684a5.01,5.01,0,0,1,1.051.78ZM20,19a3,3,0,0,1-3,3H7a3,3,0,0,1-3-3V5A3,3,0,0,1,7,2h4.515c.164,0,.323.032.485.047V7a3,3,0,0,0,3,3h4.953c.015.162.047.32.047.485Z"/>
    </SvgIcon>
));

export const FileFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
        <path fill="currentColor" d="M320,170.667h139.52c-7.448-19.736-19.019-37.656-33.941-52.565l-74.325-74.368c-14.927-14.905-32.852-26.468-52.587-33.92v139.52C298.667,161.115,308.218,170.667,320,170.667z"/>
        <path fill="currentColor" d="M468.821,213.333H320c-35.346,0-64-28.654-64-64V0.512C252.565,0.277,249.131,0,245.653,0h-96.32C90.452,0.071,42.737,47.786,42.667,106.667v298.667C42.737,464.214,90.452,511.93,149.333,512h213.333c58.881-0.07,106.596-47.786,106.667-106.667V223.68C469.333,220.203,469.056,216.768,468.821,213.333z"/>
    </SvgIcon>
));

export const PowerPointIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M19.95,5.54l-3.49-3.49c-1.32-1.32-3.08-2.05-4.95-2.05H7C4.24,0,2,2.24,2,5v14c0,2.76,2.24,5,5,5h10c2.76,0,5-2.24,5-5V10.49c0-1.87-.73-3.63-2.05-4.95Zm-1.41,1.41c.32,.32,.59,.67,.81,1.05h-4.34c-.55,0-1-.45-1-1V2.66c.38,.22,.73,.49,1.05,.81l3.49,3.49Zm1.46,12.05c0,1.65-1.35,3-3,3H7c-1.65,0-3-1.35-3-3V5c0-1.65,1.35-3,3-3h4.51c.16,0,.33,0,.49,.02V7c0,1.65,1.35,3,3,3h4.98c.02,.16,.02,.32,.02,.49v8.51Zm-10,1c-.55,0-1-.45-1-1v-5c0-1.1,.9-2,2-2h1c1.65,0,3,1.35,3,3s-1.35,3-3,3h-1v1c0,.55-.45,1-1,1Zm1-4h1c.55,0,1-.45,1-1s-.45-1-1-1h-1v2Z"/>
    </SvgIcon>
));

export const PowerPointFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M13,16c0,.55-.45,1-1,1h-1v-2h1c.55,0,1,.45,1,1Zm2-8h6.54c-.35-.91-.88-1.75-1.59-2.46l-3.48-3.49c-.71-.71-1.55-1.24-2.46-1.59V7c0,.55,.45,1,1,1Zm7,2.49v8.51c0,2.76-2.24,5-5,5H7c-2.76,0-5-2.24-5-5V5C2,2.24,4.24,0,7,0h4.51c.16,0,.32,.01,.49,.02V7c0,1.65,1.35,3,3,3h6.98c.01,.16,.02,.32,.02,.49Zm-7.06,4.92c-.28-1.42-1.6-2.4-3.06-2.4h-.66c-1.34,0-2.23,.9-2.23,2v5c0,.55,.45,1,1,1s1-.45,1-1v-1h1c1.85,0,3.31-1.68,2.94-3.6Z"/>
    </SvgIcon>
));

export const SpreadsheetIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M16,14h-3v-2c0-1.103-.897-2-2-2h-3c-1.103,0-2,.897-2,2v6c0,1.103,.897,2,2,2h8c1.103,0,2-.897,2-2v-2c0-1.103-.897-2-2-2Zm-5,4h-3v-2h3v2Zm0-4h-3v-2h3v2Zm5,4h-3v-2h3v2Zm3.949-12.465l-3.484-3.484c-1.322-1.322-3.08-2.051-4.95-2.051H7C4.243,0,2,2.243,2,5v14c0,2.757,2.243,5,5,5h10c2.757,0,5-2.243,5-5V10.485c0-1.87-.729-3.628-2.051-4.95Zm-1.414,1.414c.318,.318,.587,.671,.806,1.051h-4.341c-.552,0-1-.448-1-1V2.659c.38,.218,.733,.488,1.051,.806l3.484,3.484Zm1.465,12.051c0,1.654-1.346,3-3,3H7c-1.654,0-3-1.346-3-3V5c0-1.654,1.346-3,3-3h4.515c.163,0,.325,.008,.485,.023V7c0,1.654,1.346,3,3,3h4.977c.015,.16,.023,.322,.023,.485v8.515Z"/>
    </SvgIcon>
));

export const SpreadsheetFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M14,7V.46c.913,.346,1.753,.879,2.465,1.59l3.484,3.486c.712,.711,1.245,1.551,1.591,2.464h-6.54c-.552,0-1-.449-1-1Zm-1,12h3v-2h-3v2Zm-5-4h3v-2h-3v2Zm0,4h3v-2h-3v2Zm13.976-9h-6.976c-1.654,0-3-1.346-3-3V.024c-.161-.011-.322-.024-.485-.024H7C4.243,0,2,2.243,2,5v14c0,2.757,2.243,5,5,5h10c2.757,0,5-2.243,5-5V10.485c0-.163-.013-.324-.024-.485Zm-3.976,9c0,1.103-.897,2-2,2H8c-1.103,0-2-.897-2-2v-6c0-1.103,.897-2,2-2h3c1.103,0,2,.897,2,2v2h3c1.103,0,2,.897,2,2v2Z"/>
    </SvgIcon>
));

export const ClipIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M22.95,9.6a1,1,0,0,0-1.414,0L10.644,20.539a5,5,0,1,1-7.072-7.071L14.121,2.876a3,3,0,0,1,4.243,4.242L7.815,17.71a1.022,1.022,0,0,1-1.414,0,1,1,0,0,1,0-1.414l9.392-9.435a1,1,0,0,0-1.414-1.414L4.987,14.882a3,3,0,0,0,0,4.243,3.073,3.073,0,0,0,4.243,0L19.778,8.532a5,5,0,0,0-7.071-7.07L2.158,12.054a7,7,0,0,0,9.9,9.9L22.95,11.018A1,1,0,0,0,22.95,9.6Z"/>
    </SvgIcon>
));

export const PeopleStarMenuIconV2: React.FC<IconProps> = React.memo(({ width = "24", height = "24", ...props }) => (
    <SvgIcon viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path fill="none" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M9.16 10.87C9.06 10.86 8.94 10.86 8.83 10.87C6.45 10.79 4.56 8.84 4.56 6.44C4.56 3.99 6.54 2 9 2C11.45 2 13.44 3.99 13.44 6.44C13.43 8.84 11.54 10.79 9.16 10.87Z"/>
        <path fill="none" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M16.41 4C18.35 4 19.91 5.57 19.91 7.5C19.91 9.39 18.41 10.93 16.54 11C16.46 10.99 16.37 10.99 16.28 11"/>
        <path fill="none" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M4.16 14.56C1.74 16.18 1.74 18.82 4.16 20.43C6.91 22.27 11.42 22.27 14.17 20.43C16.59 18.81 16.59 16.17 14.17 14.56C11.43 12.73 6.92 12.73 4.16 14.56Z"/>
        <path fill="none" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M18.34 20C19.06 19.85 19.74 19.56 20.3 19.13C21.86 17.96 21.86 16.03 20.3 14.86C19.75 14.44 19.08 14.16 18.37 14"/>
        {/* Circle and star element from PersonListMenuIconV2 */}
        <path fill="var(--mui-palette-background-paper, white)" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="M23 17.75C23 18.73 22.72 19.67 22.24 20.45C21.96 20.93 21.61 21.35 21.2 21.69C20.28 22.51 19.08 23 17.75 23C16.6 23 15.54 22.63 14.68 22C14.11 21.59 13.63 21.06 13.26 20.45C12.78 19.67 12.5 18.73 12.5 17.75C12.5 16.1 13.26 14.61 14.47 13.66C15.37 12.93 16.52 12.5 17.75 12.5C18.98 12.5 20.11 12.92 21 13.63C22.22 14.59 23 16.08 23 17.75Z"/>
        <path fill="var(--mui-palette-background-paper, white)" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M17.75 20.25C17.75 18.87 18.87 17.75 20.25 17.75C18.87 17.75 17.75 16.63 17.75 15.25C17.75 16.63 16.63 17.75 15.25 17.75C16.63 17.75 17.75 18.87 17.75 20.25Z" />
    </SvgIcon>
));
...
export const WarningHexagonIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m23.34,9.48l-3.5-6c-.893-1.53-2.547-2.48-4.319-2.48h-7.072c-1.771,0-3.426.95-4.319,2.48L.631,9.48c-.907,1.554-.907,3.485,0,5.039l3.5,6c.893,1.53,2.547,2.48,4.319,2.48h7.072c1.771,0,3.426-.95,4.319-2.48l3.5-6c.907-1.554.907-3.485,0-5.039Zm-1.728,4.031l-3.5,6c-.536.918-1.528,1.488-2.591,1.488h-7.072c-1.063,0-2.056-.57-2.591-1.488l-3.5-6c-.544-.933-.544-2.091,0-3.023l3.5-6c.536-.918,1.528-1.488,2.591-1.488h7.072c1.063,0,2.056.57,2.591,1.488l3.5,6c.544.933.544,2.091,0,3.023Zm-10.613-1.012v-5.5c0-.553.448-1,1-1s1,.447,1,1v5.5c0,.553-.448,1-1,1s-1-.447-1-1Zm2.5,4c0,.828-.672,1.5-1.5,1.5s-1.5-.672-1.5-1.5.672-1.5,1.5-1.5,1.5.672,1.5,1.5Z"/>
    </SvgIcon>
));

export const WarningHexagonFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m23.34,9.48l-3.5-6c-.893-1.53-2.547-2.48-4.319-2.48h-7.072c-1.771,0-3.426.95-4.319,2.48L.631,9.48c-.907,1.554-.907,3.485,0,5.039l3.5,6c.893,1.53,2.547,2.48,4.319,2.48h7.072c1.771,0,3.426-.95,4.319-2.48l3.5-6c.907-1.554.907-3.485,0-5.039Zm-12.34-2.48c0-.553.448-1,1-1s1,.447,1,1v5.5c0,.553-.448,1-1,1s-1-.447-1-1v-5.5Zm1,11c-.828,0-1.5-.672-1.5-1.5s.672-1.5,1.5-1.5,1.5.672,1.5,1.5-.672,1.5-1.5,1.5Z"/>
    </SvgIcon>
));

export const WarningOctagonIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m22.242,5.272l-3.515-3.515c-1.133-1.133-2.64-1.757-4.242-1.757h-4.971c-1.603,0-3.109.624-4.242,1.757l-3.515,3.514c-1.134,1.133-1.758,2.64-1.758,4.243v4.971c0,1.603.624,3.11,1.758,4.243l3.515,3.515c1.133,1.133,2.64,1.757,4.242,1.757h4.971c1.603,0,3.109-.624,4.242-1.757l3.515-3.514c1.134-1.133,1.758-2.64,1.758-4.243v-4.971c0-1.603-.624-3.11-1.758-4.243Zm-.242,9.213c0,1.069-.416,2.073-1.172,2.829l-3.515,3.515c-.756.755-1.76,1.171-2.828,1.171h-4.971c-1.068,0-2.072-.416-2.828-1.171l-3.515-3.515c-.756-.755-1.172-1.759-1.172-2.828v-4.971c0-1.069.416-2.073,1.172-2.829l3.515-3.515c.756-.755,1.76-1.171,2.828-1.171h4.971c1.068,0,2.072.416,2.828,1.171l3.515,3.515c.756.755,1.172,1.759,1.172,2.828v4.971Zm-11-.485V6c0-.552.447-1,1-1s1,.448,1,1v8c0,.552-.447,1-1,1s-1-.448-1-1Zm2.5,3.5c0,.828-.672,1.5-1.5,1.5s-1.5-.672-1.5-1.5.672-1.5,1.5-1.5,1.5.672,1.5,1.5Z"/>
    </SvgIcon>
));

export const WarningOctagonFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const WarningSquareIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m13.5,17.5c0,.828-.672,1.5-1.5,1.5s-1.5-.672-1.5-1.5.672-1.5,1.5-1.5,1.5.672,1.5,1.5Zm-1.5-3c.553,0,1-.447,1-1v-7.5c0-.553-.447-1-1-1s-1,.447-1,1v7.5c0,.553.447,1,1,1Zm12-9.5v14c0,2.757-2.243,5-5,5H5c-2.757,0-5-2.243-5-5V5C0,2.243,2.243,0,5,0h14c2.757,0,5,2.243,5,5Zm-2,0c0-1.654-1.346-3-3-3H5c-1.654,0-3,1.346-3,3v14c0,1.654,1.346,3,3,3h14c1.654,0,3-1.346,3-3V5Z"/>
    </SvgIcon>
));

export const WarningSquareFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="m19,0H5C2.243,0,0,2.243,0,5v14c0,2.757,2.243,5,5,5h14c2.757,0,5-2.243,5-5V5c0-2.757-2.243-5-5-5Zm-8,6c0-.553.447-1,1-1s1,.447,1,1v7.5c0,.553-.447,1-1,1s-1-.447-1-1v-7.5Zm1,13c-.828,0-1.5-.672-1.5-1.5s.672-1.5,1.5-1.5,1.5.672,1.5,1.5-.672,1.5-1.5,1.5Z"/>
    </SvgIcon>
));

export const WarningSquareCircleIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <g>
            <path fill="currentColor" d="M12,1C6.916,1,1.081,2.25,1.081,12s5.835,11,10.919,11,10.919-1.25,10.919-11S17.084,1,12,1Zm0,20c-5.354,0-8.919-1.53-8.919-9S6.646,3,12,3s8.919,1.53,8.919,9-3.565,9-8.919,9Z"/>
            <path fill="currentColor" d="M12,6.461c-.553,0-1,.447-1,1v5.667c0,.553,.447,1,1,1s1-.447,1-1V7.461c0-.553-.447-1-1-1Z"/>
        </g>
        <path fill="currentColor" d="M12,15.544c-.552,0-.999,.447-.999,.999s.447,.999,.999,.999,.999-.447,.999-.999-.447-.999-.999-.999Z"/>
    </SvgIcon>
));

export const WarningSquareCircleFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M12,1C6.916,1,1.081,2.25,1.081,12s5.835,11,10.919,11,10.919-1.25,10.919-11S17.084,1,12,1Zm-1,5.823c0-.553,.447-1,1-1s1,.447,1,1v5.666c0,.553-.447,1-1,1s-1-.447-1-1V6.823Zm1,11.211c-.826,0-1.496-.67-1.496-1.496s.67-1.496,1.496-1.496,1.496,.67,1.496,1.496-.67,1.496-1.496,1.496Z"/>
    </SvgIcon>
));

export const WarningTriangleIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M11,13V7c0-.55,.45-1,1-1s1,.45,1,1v6c0,.55-.45,1-1,1s-1-.55-1-1Zm1,2c-.83,0-1.5,.67-1.5,1.5s.67,1.5,1.5,1.5,1.5-.67,1.5-1.5-.67-1.5-1.5-1.5Zm11.58,4.88c-.7,1.35-2.17,2.12-4.01,2.12H4.44c-1.85,0-3.31-.77-4.01-2.12-.71-1.36-.51-3.1,.5-4.56L8.97,2.6c.71-1.02,1.83-1.6,3.03-1.6s2.32,.58,3,1.57l8.08,12.77c1.01,1.46,1.2,3.19,.49,4.54Zm-2.15-3.42s-.02-.02-.02-.04L13.34,3.67c-.29-.41-.79-.67-1.34-.67s-1.05,.26-1.36,.71L2.59,16.42c-.62,.88-.76,1.84-.4,2.53,.35,.68,1.15,1.05,2.24,1.05h15.12c1.09,0,1.89-.37,2.24-1.05,.36-.69,.22-1.65-.37-2.49Z"/>
    </SvgIcon>
));

export const WarningTriangleFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M23.08,15.33L15,2.57c-.68-.98-1.81-1.57-3-1.57s-2.32,.58-3.03,1.6L.93,15.31c-1.02,1.46-1.21,3.21-.5,4.56,.7,1.35,2.17,2.12,4.01,2.12h15.12c1.85,0,3.31-.77,4.01-2.12,.7-1.35,.51-3.09-.49-4.54ZM11,7c0-.55,.45-1,1-1s1,.45,1,1v6c0,.55-.45,1-1,1s-1-.45-1-1V7Zm1,12c-.83,0-1.5-.67-1.5-1.5s.67-1.5,1.5-1.5,1.5,.67,1.5,1.5-.67,1.5-1.5,1.5Z"/>
    </SvgIcon>
));

export const CrossIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const CrossCircleIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M16,8a1,1,0,0,0-1.414,0L12,10.586,9.414,8A1,1,0,0,0,8,9.414L10.586,12,8,14.586A1,1,0,0,0,9.414,16L12,13.414,14.586,16A1,1,0,0,0,16,14.586L13.414,12,16,9.414A1,1,0,0,0,16,8Z"/>
        <path fill="currentColor" d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,22A10,10,0,1,1,22,12,10.011,10.011,0,0,1,12,22Z"/>
    </SvgIcon>
));

export const CrossCircleFilledIconV2: React.FC<IconProps> = React.memo(({ ...props }) => (
    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
        <path fill="currentColor" d="M12,0C5.385,0,0,5.385,0,12s5.385,12,12,12s12-5.385,12-12C23.953,5.402,18.598,0.047,12,0z M16.625,15.211c0.431,0.374,0.459,1.006,0.059,1.438c-0.374,0.431-1.006,0.459-1.438,0.059c-0.02-0.018-0.04-0.038-0.059-0.059L12,13.207l-2.582,2.582c-0.397,0.395-1.029,0.392-1.424-0.006c-0.386-0.388-0.386-1.003,0-1.391L10.586,12l-2.582-2.582c-0.395-0.397-0.392-1.029,0.006-1.424c0.388-0.386,1.003-0.386,1.391,0L12,10.586l2.596-2.582c0.374-0.431,1.006-0.459,1.438-0.059c0.431,0.374,0.459,1.006,0.059,1.438c-0.018,0.02-0.038,0.04-0.059,0.059L13.414,12L16.625,15.211z"/>
    </SvgIcon>
));
