...
def upgrade() -> None:
    ...
    request_type = postgresql.ENUM('DIGNITARY', 'DARSHAN', 'VOLUNTEER', 'OTHER', name='requesttype')
    ...
    sa.Column('relationship_to_requester', sa.Enum('SPOUSE', 'CHILD', 'PARENT', 'RELATIVE', 'FRIEND', 'OTHER', name='personrelationshiptype'), nullable=True),
    sa.Column('attendance_status', ENUM('PENDING', 'CHECKED_IN', 'CANCELLED', 'NO_SHOW', name='attendancestatus', create_type=False), nullable=True),
    ...
    op.add_column('appointments', sa.Column('request_type', ENUM('DIGNITARY', 'DARSHAN', 'VOLUNTEER', 'OTHER', name='requesttype', create_type=False), nullable=True))
