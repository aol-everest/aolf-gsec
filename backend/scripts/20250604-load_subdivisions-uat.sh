...
# Script to load subdivisions data to the UAT database from CSV file
# Usage: ./load_subdivisions-uat.sh
...
echo "Connecting to UAT database: $DB_HOST"
...
if [ $DB_ACCESSIBLE -ne 0 ]; then
    echo "Error: Unable to connect to UAT database. Please check your database credentials and connection."
