...
# ========================================
# 20250620 - Add Contact Soft Delete Fields (UAT)
# ========================================
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}20250620 - Add Contact Soft Delete Fields (UAT)${NC}"
echo -e "${BLUE}========================================${NC}"
...
echo -e "${YELLOW}This will add soft delete fields to the user_contacts table.${NC}"
echo ""
echo "Database: $POSTGRES_DB"
echo "Host: $POSTGRES_HOST"
echo ""
...
# Main execution
main() {
    log_message "${YELLOW}🚀 Starting contact soft delete fields addition for UAT...${NC}"
    ...
    echo -e "${BLUE}   1. 🧪 Test the contact deletion functionality in UAT${NC}"
    echo -e "${BLUE}   2. ✅ Verify hard/soft delete logic works correctly${NC}"
