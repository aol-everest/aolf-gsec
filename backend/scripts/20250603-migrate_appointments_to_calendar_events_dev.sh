...
# Script to migrate approved appointments to calendar events in Development
# This script:
...
# Execute this script directly in the dev environment (local or dev server)

# Variables for Development environment
MASTER_PASSWORD="postgres"
DB_HOST="localhost"  # Adjust for your dev environment
DB_USER="postgres"
DB_NAME="aolf_gsec"
DB_PORT="5432"

echo "=========================================="
echo "Migrating Appointments to Calendar Events (DEV)"
echo "=========================================="
...
PGPASSWORD="$MASTER_PASSWORD" psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME << 'EOF'
