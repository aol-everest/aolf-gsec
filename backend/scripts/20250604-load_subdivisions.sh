...
# Script to load subdivisions data to the database from CSV file
# Usage: ./load_subdivisions.sh
...
if [ $DB_ACCESSIBLE -ne 0 ]; then
    echo "Error: Unable to connect to database. Please check your database credentials and connection."
