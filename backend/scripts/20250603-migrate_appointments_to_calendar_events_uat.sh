...
# Script to migrate approved appointments to calendar events in UAT
# This script:
...
# This should be executed after SSHing into the UAT instance using 'eb ssh'

# Variables for UAT environment
MASTER_PASSWORD=""
...
echo "=========================================="
echo "Migrating Appointments to Calendar Events (UAT)"
echo "=========================================="
