...
# Script to rename tables to geo_ prefix in development environment
# Usage: ./rename_to_geo_tables-dev.sh

# Variables - Dev environment
DB_PASSWORD=""
DB_HOST="localhost"
DB_USER="aolf_gsec_app_user"
DB_NAME="aolf_gsec"

# Set the schema
SCHEMA="public"

echo "Renaming tables to geo_ prefix in Dev environment..."
echo "Host: $DB_HOST"
...
if [ $? -ne 0 ]; then
    echo "Error: Unable to connect to database. Please check your database credentials."
    exit 1
fi
